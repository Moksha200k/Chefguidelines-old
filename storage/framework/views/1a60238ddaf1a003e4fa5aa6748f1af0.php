  ...
  <section class="pt-100 login-register">
    <div class="container">
      <div class="row login-register-cover">
        <div class="col-lg-4 col-md-6 col-sm-12 mx-auto">
          <div class="text-center">
            ...
            <button class="btn social-login hover-up mb-20"><img src="assets/imgs/template/icons/icon-google.svg"
                alt="jobbox"><strong>Sign up with Google</strong></button>
      ...
      <?php endif; ?>
          ...
          <form class="login-register text-start mt-20" action="<?php echo e(route('employer.register')); ?>" method="POST">
            <?php echo csrf_field(); ?>
        ...
        <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
            ...
            <div class="form-group">
              ...
              <input class="form-control" id="input-company" type="text" name="company" placeholder="Your Company Name"
                required>
            </div>
            ...
            <div class="login_footer form-group d-flex justify-content-between">
              <label class="cb-container">
                <input type="checkbox"><span class="text-small">Agree to our terms and policy</span><span
...
<?php echo $__env->make('includes.layout', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH D:\zennoi marketing\Projects\Software\chefguidelines.com\resources\views/employerRegister.blade.php ENDPATH**/ ?>