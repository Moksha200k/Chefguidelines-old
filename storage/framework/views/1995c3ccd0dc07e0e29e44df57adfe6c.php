...
<head>
  ...
  <!-- Include CSS for the phone input -->
...
<body>
    ...
    <div class="container">
      <div class="main-header">
        <div class="header-left">
          <div class="header-logo"><a class="d-flex" href="/"><img alt="jobBox"
                src="assets/imgs/template/chefguidelines white logo.svg"></a></div>
        </div>
        ...
        <div class="header-right">
          ...
          <!-- Sign In -->
          <div class="block-signin"><a class="text-link-bd-btom hover-up" href="/login">Sign In</a>
            <!-- Post Ad -->
            <a class="btn btn-default btn-shadow ml-40 hover-up" href="page-signin.html">Post Ad</a>
          </div>
        </div>
      </div>
    </div>
  ...
  <!-- inputs other pages content inbetween header and footer -->
    ...
    <div class="container">
      <div class="row">
        <div class="footer-col-1 col-md-3 col-sm-12"><a href="index.html"><img alt="jobBox"
          ...
          <div class="mt-20 mb-20 font-xs color-text-paragraph-2">JobBox is the heart of the design community and the
          ...
          <div class="footer-social"><a class="icon-socials icon-facebook" href="#"></a><a
              class="icon-socials icon-twitter" href="#"></a><a class="icon-socials icon-linkedin" href="#"></a></div>
        </div>
        ...
        <div class="footer-col-6 col-md-3 col-sm-12">
          ...
          <p class="color-text-paragraph-2 font-xs">Download our Apps and get extra 15% Discount on your first
            Order&mldr;!</p>
          <div class="mt-15"><a class="mr-5" href="#"><img src="assets/imgs/template/icons/app-store.png"
                alt="joxBox"></a><a href="#"><img src="assets/imgs/template/icons/android.png" alt="joxBox"></a></div>
        </div>
      </div>
      <div class="footer-bottom mt-50">
        <div class="row">
          <div class="col-md-6"><span class="font-xs color-text-paragraph">Copyright &copy; 2022. JobBox all right
              reserved</span></div>
...
</html><?php /**PATH D:\zennoi marketing\Projects\Software\chefguidelines.comold\resources\views/includes/layout.blade.php ENDPATH**/ ?>