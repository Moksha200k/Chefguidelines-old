        ...
        <div class="col-lg-4 col-md-6 col-sm-12 mx-auto">
          <div class="text-center">
            ...
            <button class="btn social-login hover-up mb-20"><img src="assets/imgs/template/icons/icon-google.svg"
                alt="jobbox"><strong>Sign in with Google</strong></button>
          ...
          <form class="login-register text-start mt-20" action="{{ route('login') }}" method="POST">
            ...
            <div class="form-group">
              ...
              <input class="form-control" id="input-1" type="text" name="email" value="{{ old('email') }}" required
                autofocus>
              @error('email')
        ...
        @enderror
            ...
            <div class="login_footer form-group d-flex justify-content-between">
              <label class="cb-container">
                <input type="checkbox" name="remember"><span class="text-small">Remember me</span><span
